<script>
    ...
    function calc() {
        ...
        one = document.autoSumForm.jumlah_family.value;
        ...
        if (one > 7) {
            diskon = document.autoSumForm.diskon.value = (tothari * 1) * (one * 1) * (two * 1) * 8 / 100;
            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-register-image ">
                        <img class="img-fluid mb-3 mb-lg-0 pt-5 px-4 " src="<?= base_url('assets/img/family.JPEG') ?>" alt="">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">booking kamar family hotel susaluk</h1>
                            </div>
                            <form class="user" method="post" name='autoSumForm' action="<?= base_url('booking/ngebooking_family') ?>">
                                ...
                                <div class="form-group">
                                    <input type="jenis_kamar" class="form-control form-control-user mt-3" id="jenis_kamar" name="jenis_kamar" placeholder="masukan jenis kamar" value="FAMILY">
                                    <?= form_error('jenis_kamar', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="number" class="form-control form-control-user mt-3" id="jumlah_family" name="jumlah_family" placeholder="masukan jumlah kamar " onfocus="startCalc();" onblur="stopBlur();">
                                        <?= form_error('jumlah_family', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label class="mt-3" for="">harga</label>
                                        <input type="harga" class="form-control form-control-user mt-1" id="harga" name="harga" placeholder="masukan harga" onfocus="startCalc();" onblur="stopBlur();" value="499000">
