                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">daftar admin hotel susaluk</h1>
                            </div>
                            <form class="user" method="post" action="<?= base_url('admin/daftar_admin') ?>">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" class="form-control form-control-user mt-3" id="sandi" name="sandi" placeholder="masukan Password">
