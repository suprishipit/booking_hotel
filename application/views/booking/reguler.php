<script>
    ...
    function calc() {
        ...
        one = document.autoSumForm.jumlah_reguler.value;
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">booking kamar reguler hotel susaluk</h1>
                            </div>
                            <form class="user" method="post" name='autoSumForm' action="<?= base_url('booking/ngebooking_reguler') ?>">
                                ...
                                <div class="form-group">
                                    <input type="jenis_kamar" class="form-control form-control-user mt-3" id="jenis_kamar" name="jenis_kamar" placeholder="masukan jenis kamar" value="REGULER">
                                    <?= form_error('jenis_kamar', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="number" class="form-control form-control-user mt-3" id="jumlah_reguler" name="jumlah_reguler" placeholder="masukan jumlah kamar" onfocus="startCalc();" onblur="stopBlur();">
                                        <?= form_error('jumlah_reguler', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <label class="mt-3" for="">harga</label>
                                        <input type="harga" class="form-control form-control-user mt-1" id="harga" name="harga" placeholder="masukan harga" onfocus="startCalc();" onblur="stopBlur();" value="299000">
